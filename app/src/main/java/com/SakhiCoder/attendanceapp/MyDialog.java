...
public class MyDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));//From Google
        return dialog;
    }
    ...
    private Dialog getUpdateStudentDialog() {
        ...
        EditText roll_edt = view.findViewById(R.id.etd01);
    ...
    private Dialog getUpdateClassDialog() {
        ...
        EditText class_edit=view.findViewById(R.id.etd01);
    ...
    private Dialog getAddClassDialog() {
        ...
        EditText class_edt = view.findViewById(R.id.etd01);
